/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/barakg/playground/rookieboard-sw-demo/utils/toolchain/crosstool-ng_configuration/.build/src/gcc-linaro-6.3-2017.02/gcc/config/arm/arm.md'.  */
